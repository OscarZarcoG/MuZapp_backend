# Generated by Django 5.2 on 2025-06-14 03:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Última actualización')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de borrado')),
                ('nombre_cliente', models.CharField(default='Cliente', max_length=255, verbose_name='Nombre del cliente')),
                ('telefono_cliente', models.CharField(default='Teléfono', max_length=255, verbose_name='Teléfono del cliente')),
                ('redes_sociales', models.URLField(blank=True, default='Redes sociales', verbose_name='Redes sociales')),
                ('frecuencia', models.PositiveIntegerField(verbose_name='Frecuencia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_bocinas', models.PositiveIntegerField(verbose_name='Número de bocinas')),
